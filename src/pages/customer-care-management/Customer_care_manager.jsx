        ...
        <div>
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
                ...
                <div style={{ marginTop: "50px", display: "flex", justifyContent: "space-between", width: "70%"}}>
                    ...
                    <img src={feedbackAnalysisImage} alt="Restaurant feedback Analysis" style={{ maxWidth: "25%", maxHeight: "20%", border: 'solid lightgray 1px', borderRadius: '20px' }} onClick={() => navigate("feedbackAnalysis")} />
                </div>
                <br></br>
                <div style={{ marginTop: "50px", display: "flex", justifyContent: "space-between", width: "70%"}}>
