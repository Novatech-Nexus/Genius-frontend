...
function OrderDetails() {
    ...
    return (
        <div style={{height: "150vh", backgroundImage: `url(${image})`, backgroundSize: "cover", display: "flex",justifyContent: "center",alignItems: "center", }}>
        <div style={{ width: "80%", margin: "auto", textAlign: "center" }}>
            ...
            <Button style={{ width: "10%", marginTop: "2rem" }} variant="outline-dark" onClick={() => navigate(-1)}>
                Back
            </Button>
        </div>
        </div>
