...
//               </div>
//               <button className={styles.btn1} type='submit'>Recover</button>
//             </div>
//           </form>

//           <div className='center'>
//                 <span>Can&apos;t get OTP? </span>
//                 <button onClick={resendOTP} type='submit' style={{ border: 'none', background: 'none', color: 'inherit', outline: 'inherit' }}>Recover</button>
//           </div>
