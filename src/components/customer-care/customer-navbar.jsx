                    ...
                    <div className="collapse navbar-collapse" id="navbarNav">
                        <ul className="navbar-nav ms-auto">
                            <li className="nav-item">
                                <a className="nav-link"  style={{ textDecoration: 'none', color: 'white' }} href="/orderMenuHome">Menu</a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link" style={{ textDecoration: 'none', color: 'white' }} href="/contact">Contact us</a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link" style={{ textDecoration: 'none', color: 'white' }} href='/feedback'>Feedback</a>
                            </li>
                        </ul>
                    </div>
                </div>
